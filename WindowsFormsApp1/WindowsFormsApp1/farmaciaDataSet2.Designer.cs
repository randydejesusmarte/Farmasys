...
namespace WindowsFormsApp1 {
    ...
    public partial class farmaciaDataSet2 : global::System.Data.DataSet {
        ...
        public partial class usuariosDataTable : global::System.Data.TypedTableBase<usuariosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public usuariosRow AddusuariosRow(string uname, string pass, string nombre, string sexo, string puesto, byte estado) {
        ...
        public partial class usuariosRow : global::System.Data.DataRow {
            ...
            public string uname {
                get {
                    try {
                        return ((string)(this[this.tableusuarios.unameColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("El valor de la columna \'uname\' de la tabla \'usuarios\' es DBNull.", e);
                    }
                }
                set {
                    this[this.tableusuarios.unameColumn] = value;
                }
            }
            ...
            public bool IsunameNull() {
                return this.IsNull(this.tableusuarios.unameColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetunameNull() {
                this[this.tableusuarios.unameColumn] = global::System.Convert.DBNull;
            }
...
namespace WindowsFormsApp1.farmaciaDataSet2TableAdapters {
    ...
    public partial class usuariosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[usuarios] WHERE (([idusuario] = @Original_idusuario) AND ((@IsNull_pass = 1 AND [pass] IS NULL) OR ([pass] = @Original_pass)) AND ((@IsNull_sexo = 1 AND [sexo] IS NULL) OR ([sexo] = @Original_sexo)) AND ((@IsNull_puesto = 1 AND [puesto] IS NULL) OR ([puesto] = @Original_puesto)) AND ((@IsNull_estado = 1 AND [estado] IS NULL) OR ([estado] = @Original_estado)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[usuarios] ([uname], [pass], [nombre], [sexo], [puesto], [estad" +
                "o]) VALUES (@uname, @pass, @nombre, @sexo, @puesto, @estado);\r\nSELECT idusuario," +
                " uname, pass, nombre, sexo, puesto, estado FROM usuarios WHERE (idusuario = SCOP" +
                "E_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[usuarios] SET [uname] = @uname, [pass] = @pass, [nombre] = @nombre, [sexo] = @sexo, [puesto] = @puesto, [estado] = @estado WHERE (([idusuario] = @Original_idusuario) AND ((@IsNull_pass = 1 AND [pass] IS NULL) OR ([pass] = @Original_pass)) AND ((@IsNull_sexo = 1 AND [sexo] IS NULL) OR ([sexo] = @Original_sexo)) AND ((@IsNull_puesto = 1 AND [puesto] IS NULL) OR ([puesto] = @Original_puesto)) AND ((@IsNull_estado = 1 AND [estado] IS NULL) OR ([estado] = @Original_estado)));
SELECT idusuario, uname, pass, nombre, sexo, puesto, estado FROM usuarios WHERE (idusuario = @idusuario)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT idusuario, uname, pass, nombre, sexo, puesto, estado FROM dbo.usuarios";
        ...
        public virtual int Fill(farmaciaDataSet2.usuariosDataTable dataTable) {
        ...
        public virtual farmaciaDataSet2.usuariosDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            farmaciaDataSet2.usuariosDataTable dataTable = new farmaciaDataSet2.usuariosDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(farmaciaDataSet2.usuariosDataTable dataTable) {
        ...
        public virtual int Delete(int Original_idusuario, string Original_pass, string Original_sexo, string Original_puesto, global::System.Nullable<byte> Original_estado) {
        ...
        public virtual int Insert(string uname, string pass, string nombre, string sexo, string puesto, global::System.Nullable<byte> estado) {
            if ((uname == null)) {
        ...
        public virtual int Update(string uname, string pass, string nombre, string sexo, string puesto, global::System.Nullable<byte> estado, int Original_idusuario, string Original_pass, string Original_sexo, string Original_puesto, global::System.Nullable<byte> Original_estado, int idusuario) {
            if ((uname == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string uname, string pass, string nombre, string sexo, string puesto, global::System.Nullable<byte> estado, int Original_idusuario, string Original_pass, string Original_sexo, string Original_puesto, global::System.Nullable<byte> Original_estado) {
            return this.Update(uname, pass, nombre, sexo, puesto, estado, Original_idusuario, Original_pass, Original_sexo, Original_puesto, Original_estado, Original_idusuario);
        }
    }
